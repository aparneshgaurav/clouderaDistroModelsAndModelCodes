...
,Text, IntWritable>{
	...
	public void setup(Context context){
		try {
			...
			mapForHoldingMaxTemperaturePerYear.put("1948", 100);
			context.write(new Text("setupKeyReducer"),new IntWritable(100));
		} catch (IOException e) {
	...
	public void reduce(Text key, Iterable<IntWritable> values,
		...
		try {
			...
			mapForHoldingMaxTemperaturePerYear.put(key.toString(), maxValue);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
	}
