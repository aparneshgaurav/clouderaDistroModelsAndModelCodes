 ...
 * 1951 56
 * 
 * hadoop jar  /usr/lib/hadoop/client/run.jar MaxTemperatureDriver /user/hadoop/input/file.txt /user/cloudera/output2
 * hdfs dfs -put file.txt /user/cloudera/input
 * hdfs dfs -mkdir /user/cloudera/input
 * hdfs dfs -cat /user/cloudera/input/part-r-00000
 * chmod 777 file.txt
 * 
